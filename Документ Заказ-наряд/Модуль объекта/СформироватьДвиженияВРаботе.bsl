Процедура СформироватьДвиженияВРаботе(Отказ, РежимПроведения)
	...
	// +++ Инфостарт #2666 14.07.2021 Полная переработка источника движений, контроля остатков, оформление резерва на нескольких складах
	//Запрос.Текст = 
	//"ВЫБРАТЬ
	...
	//|ПОМЕСТИТЬ ЗаказНарядПредварительный
	//// --- Инфостарт #1377 17.06.2021
	//|ИЗ
	...
	//// +++ Инфостарт #1377 17.06.2021 Получение таблицы резервов по давальческому сырью
	//|
	//|ОБЪЕДИНИТЬ ВСЕ
	//|
	//|ВЫБРАТЬ
	//|	асЗакупкаЗапчастей.Период,
	//|	асЗакупкаЗапчастей.Номенклатура,
	//|	ЗНАЧЕНИЕ(Справочник.ХарактеристикиНоменклатуры.ПустаяСсылка),
	//|	асЗакупкаЗапчастей.ЗаказНаряд.Организация,
	//|	асЗакупкаЗапчастей.ЗаказНаряд.RMS_СкладХраненияЗапасов,
	//|	асЗакупкаЗапчастей.ЗаказНаряд,
	//|	СУММА(асЗакупкаЗапчастей.Количество)
	//|ИЗ
	//|	РегистрСведений.асЗакупкаЗапчастей КАК асЗакупкаЗапчастей
	//|ГДЕ
	//|	асЗакупкаЗапчастей.ЗаказНаряд = &Регистратор
	//|
	//|СГРУППИРОВАТЬ ПО
	//|	асЗакупкаЗапчастей.Период,
	//|	асЗакупкаЗапчастей.ЗаказНаряд,
	...
	//|////////////////////////////////////////////////////////////////////////////////
	//|ВЫБРАТЬ
	//|	ЗаказНарядПредварительный.Период КАК Период,
	//|	ЗаказНарядПредварительный.Номенклатура КАК Номенклатура,
	//|	ЗаказНарядПредварительный.Характеристика КАК Характеристика,
	//|	ЗаказНарядПредварительный.Организация КАК Организация,
	//|	ЗаказНарядПредварительный.СтруктурнаяЕдиница КАК СтруктурнаяЕдиница,
	//|	ЗаказНарядПредварительный.Ссылка КАК Ссылка,
	//|	СУММА(ЗаказНарядПредварительный.Количество) КАК Количество
	//|ПОМЕСТИТЬ ЗаказНаряд
	//|ИЗ
	//|	ЗаказНарядПредварительный КАК ЗаказНарядПредварительный
	//|
	//|СГРУППИРОВАТЬ ПО
	//|	ЗаказНарядПредварительный.Период,
	//|	ЗаказНарядПредварительный.Номенклатура,
	//|	ЗаказНарядПредварительный.Организация,
	//|	ЗаказНарядПредварительный.Характеристика,
	//|	ЗаказНарядПредварительный.СтруктурнаяЕдиница,
	//|	ЗаказНарядПредварительный.Ссылка
	//// --- Инфостарт #1377 17.06.2021
	//|;
	//|
	//|////////////////////////////////////////////////////////////////////////////////
